...
function DisableBase()
    if(UEFM5IslandBase) then
        ...
        UEFM5IslandBase:SetRadius(2)
        --[[
        UEFM5IslandBase.ActivationFunctions:PatrolActive(false)
        UEFM5IslandBase:SetSupportACUCount(0)
        UEFM5IslandBase:SetEngineerCount(0)
